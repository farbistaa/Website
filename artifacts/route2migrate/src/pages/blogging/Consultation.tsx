...
## Service Overview: What We Provide
...
In the age of online forums and unregulated "consultants," getting advice from a Licensed Regulated Canadian Immigration Consultant (RCIC) is more important than ever. We are a professional immigration consultancy firm led by RCIC Riffat H. Mohaimen (R710078). Here is why you should trust us with your Canadian dream:

* **Legal Authority:** An RCIC is legally authorized by the Canadian government to provide immigration advice and represent clients. We are accountable to the College of Immigration and Citizenship Consultants (CICC).
* **Up-to-Date Knowledge:** Immigration laws change frequently. We continuously update our knowledge to reflect the latest IRCC policies, ensuring your strategy is based on current law, not outdated forum posts.
* **Objective Assessment:** We provide an unbiased, realistic evaluation of your chances. We won't push you into a program just to make a sale; we guide you toward the pathway with the highest legal probability of success.
* **Confidentiality:** Your personal information and immigration history are handled with strict legal confidentiality.
...
<div className="my-8 grid grid-cols-1 gap-6 not-prose">
  <div className="p-6 bg-slate-50 border border-gray-200 rounded-xl">
    ...
    <ul className="list-disc pl-5 space-y-2 text-sm text-muted-foreground">
      ...
      <li>Direct access to RCIC expertise</li>
      <li>Clarification on processing times</li>
      <li>Guidance on immediate next steps</li>
    </ul>
  </div>
  ...
  <div className="p-6 bg-slate-50 border border-gray-200 rounded-xl">
    ...
    <ul className="list-disc pl-5 space-y-2 text-sm text-muted-foreground">
      ...
      <li>Clear roadmap for your chosen path</li>
      <li>Review of potential profile red flags</li>
      <li>Timeline expectation setting</li>
    </ul>
  </div>
  ...
  <div className="p-6 bg-slate-50 border border-gray-200 rounded-xl">
    ...
    <ul className="list-disc pl-5 space-y-2 text-sm text-muted-foreground">
      ...
      <li>Re-application action plan</li>
      <li>Assessment of admissibility concerns</li>
      <li>Review of supporting documents</li>
    </ul>
  </div>
  ...
  <div className="p-6 bg-slate-50 border border-gray-200 rounded-xl">
    ...
    <ul className="list-disc pl-5 space-y-2 text-sm text-muted-foreground">
      ...
      <li>Personalized action plan for success</li>
      <li>CRS score optimization strategy</li>
      <li>Spousal and family inclusion planning</li>
    </ul>
  </div>
</div>
...
All consultations are conducted virtually via secure video conferencing (Zoom or Google Meet). Once you book your slot, you will receive an email with the meeting link and instructions on how to prepare for your session.

### Do I need to prepare anything before the consultation?
Yes. To make the most of your time, please have your resume, educational transcripts, language test scores (if any), and a list of your specific questions ready. For refusal discussions, please have your refusal letter on hand.

### Will the consultation fee be deducted from my full application fees if I hire Route 2 Migrate?
While the consultation fee covers the legal time and expertise provided during the session, we often credit a portion of the consultation fee toward your full representation package if you choose to proceed with our firm for your visa application within a specified timeframe.
  `
};
